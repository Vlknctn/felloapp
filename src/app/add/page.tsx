  ...
  return (
    <div className="flex flex-col min-h-full" style={{ backgroundColor: "var(--bg-base)" }}>
          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className="flex flex-col items-center gap-1.5 py-2.5 rounded-[14px] transition-all"
                style={{
      ...
      <div className="rounded-t-[24px] px-5 pt-5 pb-8" style={{ backgroundColor: "var(--bg-surface)", borderTop: "1px solid var(--border-subtle)" }}>
        <div className="grid grid-cols-3 gap-y-1 mb-5">
          {["1", "2", "3", "4", "5", "6", "7", "8", "9", ".", "0"].map((num) => (
            <button
              ...
              className="h-14 flex items-center justify-center text-[24px] font-mono font-semibold rounded-[14px] active:opacity-60 transition-opacity"
          ...
          <button
            ...
            className="h-14 flex items-center justify-center text-[16px] font-semibold rounded-[14px] active:opacity-60 transition-opacity"
        ...
        <Link
          href="/"
          className="flex items-center justify-center w-full h-14 rounded-[16px] font-semibold text-[16px] transition-all active:scale-[0.98]"
          style={{
